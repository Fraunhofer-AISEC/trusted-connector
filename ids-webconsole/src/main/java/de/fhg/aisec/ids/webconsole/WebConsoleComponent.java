...
public class WebConsoleComponent {
    ...
    private static OsgiServiceManager serviceManager = new OsgiServiceManager(WebConsoleComponent.class);
    ...
    static {
        serviceManager.bindService(Settings.class,
                settingsService -> settings = settingsService,
                () -> settings = null);
        serviceManager.bindService(ContainerManager.class,
                containerManager -> cml = containerManager,
                () -> cml = null);
        serviceManager.bindService(AcmeClient.class,
                acmeClientService -> acmeClient = acmeClientService,
                () -> acmeClient = null);
        serviceManager.bindService(RouteManager.class,
                routeManager -> rm = routeManager,
                () -> rm = null);
        serviceManager.bindService(ConnectionManager.class,
                connectionManagerService -> connectionManager = connectionManagerService,
                () -> connectionManager = null);
        serviceManager.bindService(PAP.class,
                papService -> pap = papService,
                () -> pap = null);
    }
