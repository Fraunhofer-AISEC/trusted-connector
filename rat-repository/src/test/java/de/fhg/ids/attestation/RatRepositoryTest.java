...
public class RatRepositoryTest {
	...
	private final static int PORT = AvailablePortFinder.getNextAvailable();
    ...
    }		Gson gson = new GsonBuilder().registerTypeAdapter(ByteString.class,
    ...
    public void testDefaultConfiguration() throws SQLException, IOException {
		...
		List<Configuration> config = gson.fromJson(Files.newBufferedReader(
    ...
    public void testBASICConfiguration() {
        ...
        ConnectorMessage msg = ConnectorMessage
				...
				.setAttestationRepositoryRequest(AttestationRepositoryRequest.newBuilder()
