...
/**
 * TPM_ALG_ID contains an enum ALG_ID, which represents all possible 
 * algorithms used in conjunction with TPM 2.0.
 * 
 * @author georgraess
 * @version 1.0.3
 * @since 01.12.2016
...
public class TPM_ALG_ID extends StandardTPMStruct {
	...
	public enum ALG_ID {
		...
		TPM_ALG_HMAC			((short)0x05, "HMAC"),
		TPM_ALG_AES				((short)0x06, "AES"),
		TPM_ALG_MGF1			((short)0x07, "MGF1"),
		TPM_ALG_KEYEDHASH		((short)0x08, "KEYEDHASH"),
		TPM_ALG_XOR				((short)0x0A, "XOR"),
