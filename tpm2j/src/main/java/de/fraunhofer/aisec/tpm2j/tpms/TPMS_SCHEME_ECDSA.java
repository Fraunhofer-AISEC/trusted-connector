...
public class TPMS_SCHEME_ECDSA implements TPMU_ASYM_SCHEME, TPMU_SIG_SCHEME {
	/*
	...
	public void setHashId(TPMS_SCHEME_SIGHASH hashAlg) {
    ...
    public String toString() {
		return "TPMS_SCHEME_ECDSA:[scheme=" + this.hashAlg.toString() + "]";
    }
}
