...
public class Transition {
   ...
   *
   * @param evtName the event triggering this transition.
   ...
   */
  public Transition(
      String evtName, String startState, String endState, TransitionListener runBeforeTransition) {
  ...
  public Transition(
      Object evtKey, String startState, String endState, TransitionListener runBeforeTransition) {
    this.evtName = evtKey;
    this.startState = startState;
    this.endState = endState;
    this.before = runBeforeTransition;
  ...
  public Transition(
      ...
      TransitionListener runBeforeTransition) {
    this.evtName = evtKey;
   ...
   * any Throwables. No exceptions will be thrown from this method.
   *
   * @return
   */
