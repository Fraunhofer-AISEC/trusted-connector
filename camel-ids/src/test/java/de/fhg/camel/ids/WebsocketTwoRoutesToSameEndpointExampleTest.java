    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                WebsocketComponent websocketComponent = (WebsocketComponent) context.getComponent("ids");
                websocketComponent.setMinThreads(1);
                websocketComponent.setMaxThreads(20);
                
                from("ids://localhost:" + port + "/bar")
                        .log(">>> Message received from BAR WebSocket Client : ${body}")
                        .transform().simple("The bar has ${body}")
                        .to("ids://localhost:" + port + "/bar");
                ...
                from("timer://foo?fixedRate=true&period=12000")
                        ...
                        .to("ids://localhost:" + port + "/bar?sendToAll=true");
            }
        };
    }
}
